        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="relative z-4">
              <div className="w-14 h-8 rounded-xl bg-[#8b5cf6]/20 flex items-center justify-center mb-4 border border-[#8b5cf6]/30">
                <Building2 className="text-[#8b5cf6] w-8 h-8" />
              </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="glass-card p-10 relative overflow-hidden group border-[#8b5cf6]/20"
          >
            <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-110 transition-transform">
              <User size={120} />
            </div>
            <div className="relative z-10">
              <div className="w-4 h-4 rounded-xl bg-[#8b5cf6]/20 flex items-center justify-center mb-8 border border-[#8b5cf6]/30">
